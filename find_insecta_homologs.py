...
import pandas as pd
from find_homologs_swissprot import read_protein_seq, discarded_short_seq
...
def filter_calcium_channels_seq(seq_dict, tsv_df):
    ...
    """After create an updated dictionary with the sequences descriptions, filter only seq described as 'calcium' or 'Ca'"""
    calcium_dict = {}
    not_calcium_dict = {}
    cav1_Ltype = {}
    cav2_Atype = {}
...
if __name__ == '__main__':
    ...
    calcium_dict, not_calcium_dict, cav1_Ltype, cav2_Atype, cav3_Ttype, other_types = filter_calcium_channels_seq(cac_seq_dict_cav1_fly, tsv_cav1_df)
    ...
    #filtered_calcium_dict2 = filter_calcium_channels_seq(cac_seq_dict_cav2_fly, tsv_cav2_df)
    ...
    #filtered_calcium_dict3 = filter_calcium_channels_seq(cac_seq_dict_cav3_fly, tsv_cav3_df)
    #print(len(filtered_calcium_dict3))

    #if filtered_calcium_dict1 == filtered_calcium_dict2 and filtered_calcium_dict1 == filtered_calcium_dict3:
